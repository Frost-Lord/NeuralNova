...
module.exports = {
    ...
    execute: async (message) => {
        ...
        if (predictionResult.predictedIntent) {
            ...
            const ResponseMessage = predictionResult?.responseMessage ? predictionResult.responseMessage : `The predicted intent is **${predictionResult.predictedIntent}** with a confidence of ${Percentage}`;
            const ResponseTitle = `Prediction Result:`;
